...
def load_features(dataset_name):
    if dataset_name == 'Holiday_vgg16':
        with open('/home1/surfzjy/bytecamp/CBIR/feat_extract/holiday_vgg16_2_feat.pk') as pk_file:
    ...
    if dataset_name == 'Holiday_res18':
        with open('/home1/surfzjy/bytecamp/CBIR/feat_extract/holiday_resnet18_feat.pk') as pk_file:
            features_obj = pickle.load(pk_file)
        with open('./datasets/Holiday/gt.pk') as pk_file:
            gt_obj = pickle.load(pk_file)
        return features_obj, gt_obj
