...
modules = list(vgg16.children())[0][:28]      # delete the last fc layer.  27:befre relu, 28:after relu
# pdb.set_trace()

modules = nn.Sequential(modules, nn.AvgPool2d(14))
...
# print(feat_dict)
with open("holiday_vgg16_2_feat.pk", "wb") as f:
